...
.good_detail .drug_info .second_level,
.good_detail .drug_info .third_level,
.good_detail .drug_info .fourth_level {
    height: 1rem;
    line-height: 1rem;
    margin-top: 1.5rem;
    font-size: 1rem;
...
.good_detail .drug_info .second_level span,
.good_detail .drug_info .third_level span,
.good_detail .drug_info .fourth_level span {
    color: #666666;
}

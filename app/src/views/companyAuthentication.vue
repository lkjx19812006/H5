    ...
    data() {
        ...
        methods: {
            ...
            getUrl(param) {
                let _self = this;
                if (param.index == 0) {
                    _self.leftArr[0].path = param.url;
                } else if (param.index == 1) {
                    _self.leftArr[1].path = param.url;
                } else if (param.index == 2) {
                    _self.leftArr[2].path = param.url;
                } else if (param.index == 3) {
                    _self.leftArr[3].path = param.url;
                } else if (param.index == 4) {
                    _self.leftArr[4].path = param.url;
                } else if (param.index == 5) {
                    _self.leftArr[5].path = param.url;
                } else if (param.index == 6) {
                    _self.rightArr[0].path = param.url;
                } else if (param.index == 7) {
                    _self.rightArr[1].path = param.url;
                } else if (param.index == 8) {
                    _self.rightArr[2].path = param.url;
                } else if (param.index == 9) {
                    _self.rightArr[3].path = param.url;
                }
...
.company_authentication .first_item .maxbox,
.company_authentication .second_item .maxbox {
    width: 50%;
    height: 14rem;
    float: left;
    padding-right: 7%;
...
.company_authentication .first_item .otherbox,
.company_authentication .second_item .otherbox {
    width: 50%;
    height: 14rem;
    float: left;
    padding-left: 7%;
...
.company_authentication .first_item>div .title,
.company_authentication .second_item>div .title {
    font-size: 1.2rem;
    color: #333232;
    margin-bottom: 1.5rem;
}

.company_authentication .first_item>div .photo,
.company_authentication .second_item>div .photo {
    height: 11rem;
    width: 100%;
    background: #fff;
    overflow: hidden;
...
.company_authentication .first_item>div .point,
.company_authentication .second_item>div .point {
    font-size: 1rem;
    margin-top: 1rem;
    text-align: center;
    width: 100%;

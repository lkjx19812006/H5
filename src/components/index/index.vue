  ...
  <div class="home" id="home" ref="wrapper" :style="{ height: wrapperHeight + 'px' }">
    <div class="search" v-bind:class="{searchs:show}">
      ...
      <div class="openApp"
        ...
        <!--<a href="http://www.baidu.com" id="openApp0">1212</a>-->
        <a id="call-app" href="javascript:;" style="display: inline-block;float: right;">
          <input id="download-app" type="hidden" name="storeurl" value="http://www.yaocaimaimai.com">
          <div class="intoR">
            <span>立即进入</span>
          </div>
        </a>
    ...
    <mt-loadmore :top-method="loadTop" @top-status-change="handleTopChange" ref="loadmore">
      ...
      <div class="entrance">
        <div class="box" v-for="(todo,index) in entrance" v-bind:class="{tbox:index == 3}"
             @click="jumpEntrance(todo.router)">
          <img :src="todo.url">
          <div>{{todo.text}}</div>
        </div>
      </div>
      ...
      <div class="urgent">
        ...
        <div class="content">
          <div class="item" v-for="(todo,index) in urgentArr" v-bind:class="{first: index !== 2}"
               @click="jumpNeed(todo)">
            <div class="left">
              <div class="top">
      ...
      <div class="recommend">
        ...
        <div class="content">
          <div class="items" v-for="(todo,index) in resourceArr" v-bind:class="{firsts: index !== 2}"
               @click="jumpRes('resourceDetail/',todo.id)">
            <div class="left">
              <div class="image">
...
<script>
  ...
  export default {
    ...
    mounted(){
      ...
      console.log(isiOS, u)
      if (isiOS) {
        document.getElementById('download-app').value = 'http://baidu.com'; //IOS下载地址
      } else {
        document.getElementById('download-app').value = 'http://www.yaocaimaimai.com'; //android下载地址
      }
      ...
      var config = {
        /*scheme:必须*/
        scheme_IOS: 'YCMM://',
        scheme_Adr: 'mianguan://yaocaimaimai.yaocaimaimai',

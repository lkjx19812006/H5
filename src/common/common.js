...
let common = new Vue({
  data: {
    appId: 'wxea4a59ca11c907a7',
    appsecret: '9ef4776c87fa974a709fc29582642f3b',
    wxrun: true,
    wxshow: true,
    phoneRun: true,
    phoneType: true,
  ...
  methods: {
    ...
    getWxUrl() {
      ...
      _self.$http.post(_self.urlCommon + _self.apiUrl.most, {
        ...
        biz_param: {//https://yinqian.natappvip.cc/#/home http://apps.yaocaimaimai.com/htm5/#/wchatLogin
    ...
    isWeiXin() {
      ...
      if (url.indexOf("yinqian.natappvip.cc") !== -1) {
        if (_self.wxrun) {
